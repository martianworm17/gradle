...
abstract class IncrementalFiler implements Filer {
    ...
    public final JavaFileObject createSourceFile(CharSequence name, Element... originatingElements) throws IOException {
        recordDerivedType(name, originatingElements);
    ...
    private void recordDerivedType(CharSequence name, Element[] originatingElements) {
        result.addDerivedType(name.toString(), getTopLevelTypeNames(originatingElements));
    }
