...
public class CurrentCompilation {
    ...
    public CurrentCompilation(IncrementalTaskInputs inputs, JavaCompileSpec spec, JarClasspathSnapshotProvider jarClasspathSnapshotProvider) {
    ...
    public IncrementalTaskInputs getInputs() {
        return inputs;
    }
}
